...
function handleAttenderLogin() {
    // Simulate the login process for Attender (confirmation box)
    const isLoggedIn = confirm("Do you have an account as an Attender?"); // Example confirmation

    if (isLoggedIn) {
        // Redirect to the Attender page (replace 'attender.html' with your actual page)
        window.location.href = "attender.html"; // Change to your attender page's path
    } else {
        alert("Please sign up first.");
        // Redirect to the signup page for Attender
